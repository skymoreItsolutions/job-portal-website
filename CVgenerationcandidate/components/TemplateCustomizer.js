...
const TemplateCustomizer: React.FC<TemplateCustomizerProps> = ({ 
  ...
  const colorPresets = [
    { name: 'Professional Blue', colors: { primary: '#2563eb', secondary: '#64748b', accent: '#0ea5e9' } },
    { name: 'Creative Purple', colors: { primary: '#7c3aed', secondary: '#a78bfa', accent: '#f59e0b' } },
    { name: 'Executive Black', colors: { primary: '#1f2937', secondary: '#6b7280', accent: '#059669' } },
    { name: 'Tech Cyan', colors: { primary: '#0f172a', secondary: '#64748b', accent: '#06b6d4' } },
    { name: 'Warm Orange', colors: { primary: '#ea580c', secondary: '#f97316', accent: '#eab308' } },
    { name: 'Forest Green', colors: { primary: '#166534', secondary: '#22c55e', accent: '#84cc16' } }
  ];
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Personalize your {template.name} template</p>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="p-4 space-y-6">
              {activeTab === 'colors' && (
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Custom Colors</h3>
              ...
              {activeTab === 'fonts' && (
                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Heading Font</h3>
                    <select
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Body Font</h3>
                    <select
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <h4 className="font-semibold mb-2" style={{ fontFamily: customTemplate.fonts.heading }}>
                      Heading Preview
                    </h4>
                    <p className="text-sm" style={{ fontFamily: customTemplate.fonts.body }}>
                      This is how your body text will look with the selected fonts. 
                      The combination should be readable and professional.
                    </p>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'layout' && (
                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Column Layout</h3>
                    <div className="grid grid-cols-2 gap-3">
                      <button
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Header Style</h3>
                    <div className="space-y-2">
                      {[
                        ...
                        <button
                          key={option.value}
                          onClick={() => updateLayout({ headerStyle: option.value as any })}
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Section Spacing</h3>
                    <div className="space-y-2">
                      {[
                        ...
                        <button
                          key={option.value}
                          onClick={() => updateLayout({ sectionSpacing: option.value as any })}
                          className={`w-full p-3 text-left border rounded-lg transition-colors ${
                            customTemplate.layout.sectionSpacing === option.value
                              ? 'border-blue-500 bg-blue-50'
                              : 'border-gray-200 hover:border-gray-300'
                          }`}
                        >
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
              ...
              >
                ...
                <div className={`pb-4 border-b ${
                  customTemplate.layout.headerStyle === 'centered' ? 'text-center' :
                  customTemplate.layout.headerStyle === 'split' ? 'flex justify-between items-start' : 'text-left'
                }`}>
                  <div>
                    <h1 
                ...
                <div className={`grid gap-6 ${
                  customTemplate.layout.columns === 2 ? 'grid-cols-2' : 'grid-cols-1'
                }`}>
                  <div className={`space-y-${
                    customTemplate.layout.sectionSpacing === 'compact' ? '4' :
                    customTemplate.layout.sectionSpacing === 'spacious' ? '8' : '6'
                  }`}>
                    <div>
                      <h2 
                            ...
                            <div className="flex gap-1">
                              {[1,2,3,4].map(i => (
                                <div 
                                  ...
                                  style={{ backgroundColor: i <= 4 ? customTemplate.colors.accent : '#e5e7eb' }}
                                />
                              ))}
                            </div>
                          </div>
                            ...
                            <div className="flex gap-1">
                              {[1,2,3,4].map(i => (
                                <div 
                                  key={i}
                                  className="w-3 h-3 rounded-full"
                                  style={{ backgroundColor: i <= 3 ? customTemplate.colors.accent : '#e5e7eb' }}
                                />
                              ))}
                            </div>
                          </div>
