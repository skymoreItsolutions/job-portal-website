    ...
    <div className="bg-white rounded-lg shadow-md sticky top-4">
      <div className="p-6 border-b">
        <div className="flex items-center justify-between">
          ...
          {hasActiveFilters && (
            <button className="flex items-center px-2 py-1 text-gray-500 hover:text-gray-700 transition-colors" onClick={clearFilters}>
      ...
      <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            {['Entry Level', 'Mid Level', 'Senior Level', 'Executive'].map((level) => (
              <div key={level} className="flex items-center space-x-2">
                <input type="checkbox" id={level} className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
        ...
        <div>
          ...
          <div className="space-y-2">
            {['Technology', 'Marketing', 'Design', 'Sales', 'Finance', 'HR'].map((category) => (
