    ...
    <div className="group relative overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:shadow-xl ">
      ...
      <div className="p-6">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button
            onClick={onReadMore}
            className="group/btn flex items-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition-all duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 "
          >
            Read More
